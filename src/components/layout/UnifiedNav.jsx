                  ...
                  >
                    ...
                    <div className="px-2 space-y-1">
                      ...
                      <Link
                        to="/mis-paquetes"
                        onClick={() => setUserMenuOpen(false)}
                        className="flex items-center gap-3 rounded-xl px-3 py-2.5 text-slate-700 hover:text-purple-700 hover:bg-purple-50/70 transition"
                      >
                        <svg
                      ...
                      {location.pathname === "/mis-paquetes" && (
                        <Link
                          to="/"
                          onClick={() => setUserMenuOpen(false)}
                          className="flex items-center gap-3 rounded-xl px-3 py-2.5 text-slate-700 hover:text-green-700 hover:bg-green-50/70 transition"
                        >
                          <svg
