        ...
        <main className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
            ...
            <div className="bg-white p-6 rounded-xl shadow-md flex items-center gap-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-500">Paquetes Totales</h3>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md flex items-center gap-4">
              <div className="bg-green-100 p-3 rounded-full">
                <svg className="w-6 h-6 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v.01M12 6v-1m0-1V4m0 2v1m0 0v1m-3.343-3.343A6 6 0 0112 6m-3.343 3.343a6 6 0 000 8.486m11.314-8.486a6 6 0 010 8.486M12 18a6 6 0 01-3.343-10.657"></path></svg>
              </div>
              <div>
                <h3 className="text-lg font-semibold text-gray-500">Ventas del Mes</h3>
