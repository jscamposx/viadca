/**
 * Utilidades para logging avanzado de operaciones PATCH
 */

const LOG_PREFIX = '🔄 [PATCH]';

/**
 * Logs detallados para operaciones PATCH
...
export const logPatchOperation = (operation, data = {}) => {
  ...
  switch (operation) {
    ...
    case 'changes-detected':
      console.log(`${LOG_PREFIX} ✅ Cambios detectados: ${data.count} campo(s)`);
    ...
    case 'sending':
      console.log(`${LOG_PREFIX} 📤 Enviando actualización con ${data.fieldCount} campo(s)`);
      break;
...
/**
 * Crea un resumen detallado de los cambios para mostrar al usuario
 * @param {Object} payload - Payload del PATCH
