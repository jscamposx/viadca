...
const AlphaIndex = ({ letters, onJump, active }) => {
  return (
    <nav
      className="hidden xl:flex flex-col gap-1 fixed top-1/2 -translate-y-1/2 right-4 z-30 bg-white/70 backdrop-blur rounded-2xl p-2 shadow border border-slate-200"
