...
const DestinationCard = React.memo(function DestinationCard({ p }) {
  ...
  return (
    <article className="bg-white rounded-xl shadow-lg hover:shadow-xl hover:shadow-blue-500/10 transition-all duration-500 hover:-translate-y-2 hover:scale-[1.02] overflow-hidden border border-slate-100 group h-full flex flex-col transform-gpu">
      <div className="relative overflow-hidden">
        ...
        <div className="absolute top-3 right-3 transform transition-all duration-400 group-hover:scale-110 group-hover:-translate-y-1">
          {badge ? (
        ...
        <div className="absolute bottom-3 left-3 opacity-0 group-hover:opacity-100 transition-all duration-500 transform translate-y-2 group-hover:translate-y-0">
          <span className="bg-white/95 backdrop-blur-sm text-slate-800 px-3 py-2 rounded-lg text-xs font-medium flex items-center gap-1.5 shadow-lg border border-white/30">
