...
const Destinations = () => (
  <section id="destinos" className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 scroll-mt-32 bg-gradient-to-b from-gray-50 to-white">
    <div className="max-w-7xl mx-auto">
      <div className="text-center mb-12 lg:mb-16">
        <p className="text-slate-600 font-semibold text-base sm:text-lg uppercase tracking-wide mb-3 lg:mb-4">Destinos favoritos</p>
          ...
          <div className="p-5 lg:p-6">
            <div className="flex justify-between items-start mb-3">
              ...
              <div className="text-right">
                ...
                <div className="font-bold text-lg lg:text-xl text-green-600">$8,500</div>
              </div>
            </div>
        ...
        <article className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 overflow-hidden border border-blue-100 hover:border-blue-300 group">
          ...
          <div className="p-5 lg:p-6">
            <div className="flex justify-between items-start mb-3">
              ...
              <div className="text-right">
                <span className="text-sm text-slate-500">Desde</span>
                <div className="font-bold text-lg lg:text-xl text-green-600">$25,000</div>
              </div>
            </div>
            <div className="flex items-center text-slate-600 mb-4">
              <svg className="w-4 h-4 mr-2 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <article className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 overflow-hidden border border-blue-100 hover:border-blue-300 group">
          ...
          <div className="p-5 lg:p-6">
            <div className="flex justify-between items-start mb-3">
              ...
              <div className="text-right">
                <span className="text-sm text-slate-500">Desde</span>
                <div className="font-bold text-lg lg:text-xl text-green-600">$45,000</div>
              </div>
            </div>
            <div className="flex items-center text-slate-600 mb-4">
              <svg className="w-4 h-4 mr-2 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="text-center mt-12 lg:mt-16">
        <button className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-8 py-4 rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 font-semibold hover:shadow-lg hover:scale-105 transform inline-flex items-center gap-3">
