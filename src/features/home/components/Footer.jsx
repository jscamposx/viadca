      ...
      <div className="mt-16 pt-8 border-t border-white/60">
        <div className="flex flex-col lg:flex-row gap-6 lg:items-center lg:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-4 text-sm">
            <Link to="/privacidad" className="text-slate-600 hover:text-blue-600 transition-colors duration-300 hover:underline">
              Privacidad
            </Link>
            <span className="text-slate-300">•</span>
            <Link to="/terminos" className="text-slate-600 hover:text-blue-600 transition-colors duration-300 hover:underline">
              Términos
            </Link>
            <span className="text-slate-300">•</span>
            <Link to="/cookies" className="text-slate-600 hover:text-blue-600 transition-colors duration-300 hover:underline">
              Cookies
            </Link>
          </div>
        </div>
