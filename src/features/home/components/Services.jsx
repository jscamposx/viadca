...
const Services = () => (
  <section id="servicios" className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 relative scroll-mt-32">
    ...
    <div className="max-w-7xl mx-auto">
      <div className="text-center mb-12 lg:mb-16">
        <p className="text-slate-600 font-semibold text-base sm:text-lg uppercase tracking-wide mb-3 lg:mb-4">NUESTROS SERVICIOS</p>
        ...
        <p className="text-slate-600 text-base sm:text-lg mt-4 max-w-2xl mx-auto">
          Descubre nuestros servicios especializados diseñados para hacer de tu viaje una experiencia inolvidable
        </p>
      </div>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
        ...
        <article className="bg-white p-6 lg:p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border border-blue-100 hover:border-blue-300 group">
          <div className="w-14 h-14 lg:w-16 lg:h-16 bg-orange-200 rounded-2xl flex items-center justify-center mx-auto mb-4 lg:mb-6 group-hover:bg-orange-300 transition-colors duration-300 group-hover:scale-110 transform">
            <svg className="w-7 h-7 lg:w-8 lg:h-8 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
            </svg>
          </div>
          <h3 className="font-open-sans font-semibold text-lg lg:text-xl text-slate-800 mb-3 lg:mb-4 text-center">Tours Personalizados</h3>
        ...
        <article className="bg-white p-6 lg:p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border border-blue-100 hover:border-blue-300 relative group">
          ...
          <h3 className="font-open-sans font-semibold text-lg lg:text-xl text-slate-800 mb-3 lg:mb-4 text-center">Destinos Nacionales e Internacionales</h3>
          <p className="text-slate-600 leading-relaxed text-sm lg:text-base text-center">
        ...
        <article className="bg-white p-6 lg:p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border border-blue-100 hover:border-blue-300 group">
          ...
          <h3 className="font-open-sans font-semibold text-lg lg:text-xl text-slate-800 mb-3 lg:mb-4 text-center">Viajes Corporativos</h3>
          <p className="text-slate-600 leading-relaxed text-sm lg:text-base text-center">
        ...
        <article className="bg-white p-6 lg:p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border border-blue-100 hover:border-blue-300 group">
          ...
          <h3 className="font-open-sans font-semibold text-lg lg:text-xl text-slate-800 mb-3 lg:mb-4 text-center">Asesoría Especializada</h3>
          <p className="text-slate-600 leading-relaxed text-sm lg:text-base text-center">
      ...
      <div className="mt-12 lg:mt-16 text-center">
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 lg:p-8 border border-blue-200">
          ...
          <p className="text-slate-600 text-sm lg:text-base mb-6 max-w-2xl mx-auto">
            Nuestro equipo de expertos está aquí para ayudarte a planificar el viaje perfecto
          </p>
