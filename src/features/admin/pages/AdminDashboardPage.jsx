      ...
      <div className="max-w-7xl mx-auto">
        ...
        <header className="text-center mb-10">
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-800 mb-2">
            Panel de <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">Administración</span>
          </h1>
          <p className="text-md sm:text-lg text-gray-600 max-w-2xl mx-auto">
            Gestiona tu plataforma con herramientas avanzadas y visualización de datos en tiempo real
          </p>
        </header>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/50 p-6 transition-all duration-300 hover:shadow-xl">
            ...
            <div className="mt-4">
              <div className="flex items-center">
                ...
                <span className="text-sm text-green-500 ml-1">+12% este mes</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/50 p-6 transition-all duration-300 hover:shadow-xl">
            <div className="flex justify-between items-start">
              <div>
                ...
                <h3 className="text-3xl font-bold text-gray-800 mt-2">$8,250</h3>
              </div>
              <div className="bg-green-500/10 p-3 rounded-xl">
                <svg className="w-6 h-6 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v.01M12 6v-1m0-1V4m0 2v1m0 0v1m-3.343-3.343A6 6 0 0112 6m-3.343 3.343a6 6 0 000 8.486m11.314-8.486a6 6 0 010 8.486M12 18a6 6 0 01-3.343-10.657"></path>
                </svg>
              </div>
            </div>
            <div className="mt-4">
              <div className="flex items-center">
                ...
                <span className="text-sm text-green-500 ml-1">+24% este mes</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/50 p-6 transition-all duration-300 hover:shadow-xl">
            ...
            <div className="mt-4">
              <div className="flex items-center">
                ...
                <span className="text-sm text-green-500 ml-1">+8% este mes</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/50 p-6 transition-all duration-300 hover:shadow-xl">
            ...
            <div className="mt-4">
              <div className="flex items-center">
                ...
                <span className="text-sm text-green-500 ml-1">+3.2% este mes</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-10">
          ...
          <div className="lg:col-span-2 bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/50 p-6">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-xl font-bold text-gray-800">Rendimiento de Ventas</h2>
              <div className="flex space-x-2">
                <button className="text-sm px-3 py-1 bg-blue-50 text-blue-600 rounded-lg">Mensual</button>
                <button className="text-sm px-3 py-1 text-gray-500 rounded-lg hover:bg-gray-100">Anual</button>
              </div>
            </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/50 p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  <p className="font-medium text-gray-800">Nuevo pedido completado</p>
                  <p className="text-sm text-gray-500">Pedido #ORD-2841 por $320</p>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Pedido #ORD-2839 por $150</p>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <p className="font-medium text-gray-800">Artículo actualizado</p>
                  <p className="text-sm text-gray-500">Paquete Premium por Carlos</p>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/50 p-6 mb-10">
          <h2 className="text-xl font-bold text-gray-800 mb-6">Paquetes Más Vendidos</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="border border-gray-200 rounded-xl overflow-hidden transition-transform duration-300 hover:shadow-lg hover:-translate-y-1">
              ...
              <div className="p-4">
                <h3 className="font-bold text-lg text-gray-800">Paquete Premium</h3>
                <p className="text-gray-600 text-sm mt-1">Todo incluido con beneficios exclusivos</p>
                <div className="flex justify-between items-center mt-4">
                  <span className="font-bold text-gray-800">$499</span>
                  <span className="text-sm bg-blue-100 text-blue-800 px-2 py-1 rounded">142 ventas</span>
                </div>
              </div>
            </div>
            ...
            <div className="border border-gray-200 rounded-xl overflow-hidden transition-transform duration-300 hover:shadow-lg hover:-translate-y-1">
              ...
              <div className="p-4">
                <h3 className="font-bold text-lg text-gray-800">Paquete Empresarial</h3>
                <p className="text-gray-600 text-sm mt-1">Solución completa para negocios</p>
                <div className="flex justify-between items-center mt-4">
                  <span className="font-bold text-gray-800">$899</span>
                  <span className="text-sm bg-amber-100 text-amber-800 px-2 py-1 rounded">98 ventas</span>
                </div>
              </div>
            </div>
            ...
            <div className="border border-gray-200 rounded-xl overflow-hidden transition-transform duration-300 hover:shadow-lg hover:-translate-y-1">
              ...
              <div className="p-4">
                <h3 className="font-bold text-lg text-gray-800">Paquete Básico</h3>
                <p className="text-gray-600 text-sm mt-1">Solución esencial para principiantes</p>
                <div className="flex justify-between items-center mt-4">
                  <span className="font-bold text-gray-800">$199</span>
                  <span className="text-sm bg-green-100 text-green-800 px-2 py-1 rounded">87 ventas</span>
                </div>
              </div>
            </div>
          </div>
