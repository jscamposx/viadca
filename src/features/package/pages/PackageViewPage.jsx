    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-blue-50 px-4">
      <div className="text-center space-y-4 sm:space-y-6">
        <div className="relative">
          <div className="w-16 h-16 sm:w-20 sm:h-20 border-4 border-blue-200 rounded-full"></div>
          ...
          <div className="w-10 h-10 sm:w-12 sm:h-12 border-2 border-indigo-400 border-b-transparent rounded-full animate-spin absolute top-1.5 left-1.5 sm:top-2 sm:left-2"></div>
        </div>
        <div className="space-y-2">
          <p className="text-slate-700 font-semibold text-base sm:text-lg">Preparando tu experiencia de viaje</p>
...
// Componente de Error mejorado y responsive
function ErrorMessage({ message, onRetry }) {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-red-50 to-orange-50 p-4 sm:p-6">
      <div className="max-w-md w-full bg-white rounded-2xl sm:rounded-3xl shadow-2xl p-6 sm:p-8 text-center backdrop-blur-sm border border-red-100">
        ...
        <h3 className="text-2xl sm:text-3xl font-bold text-slate-800 mb-2 sm:mb-3">¡Ups! Algo salió mal</h3>
        <p className="text-slate-600 mb-6 sm:mb-8 leading-relaxed text-sm sm:text-base">{message}</p>
        <button
          onClick={onRetry}
...
// Componente de Not Found mejorado y responsive
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-blue-50 p-4 sm:p-6">
      <div className="max-w-md w-full bg-white rounded-2xl sm:rounded-3xl shadow-2xl p-6 sm:p-8 text-center backdrop-blur-sm border border-slate-100">
        <div className="w-20 h-20 sm:w-24 sm:h-24 bg-gradient-to-br from-slate-100 to-slate-200 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 sm:h-12 sm:w-12 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9.172 16.172a4 4 0 015.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
          </svg>
        </div>
        <h3 className="text-2xl sm:text-3xl font-bold text-slate-800 mb-2 sm:mb-3">Paquete no encontrado</h3>
        <p className="text-slate-600 mb-6 sm:mb-8 leading-relaxed text-sm sm:text-base">Lo sentimos, no pudimos encontrar el paquete que buscas. Puede que haya sido movido o ya no esté disponible.</p>
        <button
...
// Componente de badge mejorado y responsive
function Badge({ children, variant = "default", icon: Icon }) {
  ...
  return (
    <span className={`inline-flex items-center px-2 py-1 sm:px-3 sm:py-1.5 rounded-full text-xs sm:text-sm font-medium border ${variants[variant]} backdrop-blur-sm`}>
      {Icon && <Icon className="w-3 h-3 sm:w-4 sm:h-4 mr-1 sm:mr-1.5" />}
      <span className="truncate">{children}</span>
    </span>
  );
}

// Componente principal mejorado y completamente responsive
      ...
      <div className="container mx-auto px-4 py-6 sm:py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2 space-y-8 sm:space-y-12 lg:space-y-16">
            ...
            {paquete.itinerario && paquete.itinerario.length > 0 && (
              <section className="bg-white rounded-2xl sm:rounded-3xl shadow-xl p-4 sm:p-6 lg:p-8 border border-slate-100">
                <div className="flex items-center mb-4 sm:mb-6">
                  ...
                  <div>
                    <h2 className="text-2xl sm:text-3xl font-bold text-slate-900">Itinerario</h2>
                    <p className="text-slate-600 text-sm sm:text-base">Tu aventura día a día</p>
                  </div>
                </div>
            ...
            <section className="bg-white rounded-2xl sm:rounded-3xl shadow-xl p-4 sm:p-6 lg:p-8 border border-slate-100">
              <div className="flex items-center mb-4 sm:mb-6">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-xl sm:rounded-2xl flex items-center justify-center mr-3 sm:mr-4 flex-shrink-0">
                  <FiMapPin className="w-5 h-5 sm:w-6 sm:h-6 text-white" />
                </div>
                <div>
                  <h2 className="text-2xl sm:text-3xl font-bold text-slate-900">Ubicación</h2>
            ...
            {paquete.destino_lat && paquete.destino_lng && (
              <section className="bg-white rounded-2xl sm:rounded-3xl shadow-xl p-4 sm:p-6 lg:p-8 border border-slate-100">
                <div className="flex items-center mb-4 sm:mb-6">
                  ...
                  <div>
                    <h2 className="text-2xl sm:text-3xl font-bold text-slate-900">Clima</h2>
                    <p className="text-slate-600 text-sm sm:text-base">Pronóstico para tu viaje</p>
                  </div>
                </div>
                <WeatherForecast
            ...
            {paquete.requisitos && (
              <section className="bg-white rounded-2xl sm:rounded-3xl shadow-xl p-4 sm:p-6 lg:p-8 border border-slate-100">
                <div className="flex items-center mb-4 sm:mb-6">
                  ...
                  <div>
                    <h2 className="text-2xl sm:text-3xl font-bold text-slate-900">Requisitos</h2>
                    <p className="text-slate-600 text-sm sm:text-base">Lo que necesitas saber</p>
                  </div>
                </div>
          ...
          {/* Columna Derecha: Tarjeta de Reserva Responsive */}
            ...
            <div className="lg:sticky lg:top-32">
              <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl p-4 sm:p-6 lg:p-8 border border-slate-100 backdrop-blur-sm">
                ...
                <div className="text-center mb-4 sm:mb-6">
                  <div className="flex flex-col sm:flex-row items-center justify-center sm:items-baseline">
                    ...
                    <span className="ml-0 sm:ml-2 text-slate-500 text-base sm:text-lg">/ persona</span>
                  </div>
                  <p className="text-slate-600 mt-2 text-sm sm:text-base">Precio todo incluido</p>
                </div>

                {/* Incluye */}
                <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
                  <h3 className="font-semibold text-slate-900 text-base sm:text-lg">¿Qué incluye?</h3>
                  <div className="space-y-2 sm:space-y-3">
                    <div className="flex items-center">
                      <div className="w-5 h-5 sm:w-6 sm:h-6 bg-emerald-100 rounded-full flex items-center justify-center mr-2 sm:mr-3 flex-shrink-0">
                        <FiCheckSquare className="w-3 h-3 sm:w-4 sm:h-4 text-emerald-600" />
                      </div>
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="text-slate-700 text-sm sm:text-base">Guía especializado</span>
                    </div>
                  </div>
                </div>
                ...
                <button className="w-full bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 text-white font-bold py-4 sm:py-5 px-4 rounded-xl sm:rounded-2xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 hover:from-blue-700 hover:via-indigo-700 hover:to-purple-700 mb-3 sm:mb-4">
                  <span className="text-base sm:text-lg">🚀 Reservar Aventura</span>
                </button>

                {/* Información adicional */}
                <div className="space-y-1 sm:space-y-2 text-center">
                  <p className="text-xs sm:text-sm text-slate-500">
                    <FiShield className="inline w-3 h-3 sm:w-4 sm:h-4 mr-1" />
                    Pagos 100% seguros
                  </p>
                  <p className="text-xs sm:text-sm text-slate-500">
                  ...
                  <p className="text-xs sm:text-sm text-slate-500">
                    <FiUsers className="inline w-3 h-3 sm:w-4 sm:h-4 mr-1" />
                    Atención 24/7
                  </p>
                </div>
              </div>
              ...
              <div className="mt-4 sm:mt-6 bg-gradient-to-r from-emerald-50 to-teal-50 rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-emerald-200">
                <div className="flex items-center justify-center mb-2 sm:mb-3">
                  ...
                  <span className="ml-2 font-semibold text-slate-700 text-sm sm:text-base">4.9</span>
                </div>
