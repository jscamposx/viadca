...
function PaqueteDetalle() {
 ...
 if (error) return <div className="max-w-4xl mx-auto my-10 p-6 bg-red-100 border border-red-400 text-red-700 rounded-md"><Error message={error} /></div>;
 if (!paquete) return <div className="max-w-4xl mx-auto my-10 p-6 bg-gray-100 border border-gray-400 text-gray-700 rounded-md"><NotFound /></div>;
 ...
 <h2 className="text-3xl font-bold mb-2">{paquete.nombre_paquete}</h2>
 <p className="text-lg">{paquete.origen} <span className="font-semibold">→</span> {paquete.destino}</p>
 </div>
 </div>
