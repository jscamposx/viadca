    ...
    return (
      <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
        ...
        <div className="text-center py-8">
          ...
          <p className="text-gray-500 text-lg">No hay actividades programadas</p>
        </div>
      </div>
    );
  }
    ...
    <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
      <div className="flex items-center justify-between mb-6 pb-2 border-b border-gray-100">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-500">
          ...
          <span>{itinerario.length} {itinerario.length === 1 ? 'día' : 'días'}</span>
        </div>
      </div>
                          ...
                          <div className="flex flex-wrap gap-4 text-sm text-gray-600">
                            ...
                            {item.lugares && (
                              <div className="flex items-center gap-1">
                                ...
                                <span className="truncate max-w-xs">{item.lugares}</span>
                              </div>
                            )}
                          </div>
                        </div>
      ...
      <div className="mt-8 pt-6 border-t border-gray-100">
        <div className="flex items-center justify-between text-sm text-gray-600 bg-gray-50 p-4 rounded-lg">
          ...
          <span className="font-semibold text-blue-600">{itinerario.length}</span>
        </div>
      </div>
    </div>
  );
