          ...
          <div className="relative z-10 h-full flex flex-col justify-between p-12 text-white">
            <div>
              ...
              <div className="mt-16 max-w-md">
                <h2 className="text-3xl md:text-4xl font-bold mb-4">Verificación de cuenta</h2>
                <p className="text-blue-100 opacity-90">
                  Estamos verificando tu dirección de email para garantizar la seguridad de tu cuenta y activar todas las funciones disponibles.
                </p>
              </div>
            </div>
        ...
        <div className="flex-1 flex items-center justify-center min-h-[calc(100vh-80px)] md:min-h-0">
          <div className="w-full max-w-md p-4 md:p-6">
            ...
            <div className={`bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100`}>
              ...
              <div className={`bg-gradient-to-r ${statusConfig.gradient} py-6 px-8`}>
              ...
              <div className="p-6 md:p-8">
                ...
                {/* Mensaje */}
                <p className={`text-center text-base md:text-lg mb-8 ${statusConfig.text}`}>
                  {message}
                </p>
