        ...
        <div className="relative z-10 h-full flex flex-col justify-between p-12 text-white">
          <div>
            ...
            <div className="mt-16 max-w-md">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Descubre el mundo con nosotros</h2>
              <p className="text-indigo-100 opacity-90">
                Accede a tu cuenta para gestionar tus reservas, ver tus viajes próximos 
            ...
            <div className="p-6 md:p-8">
              ...
              <div className="relative my-6">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-3 bg-white text-gray-500">¿Eres nuevo?</span>
                </div>
              </div>
