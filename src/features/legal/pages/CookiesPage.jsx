        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-24">
          <div className="text-center">
            ...
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 border border-white/20 transform transition-transform hover:scale-105">
              ...
              <span className="text-sm text-purple-100 font-medium">Última actualización: {lastUpdate}</span>
            </div>
          </div>
        </div>
      ...
      <section className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20 -mt-6">
          ...
          <div className="prose prose-slate max-w-none prose-headings:font-bold prose-headings:text-slate-800 prose-h2:text-2xl md:prose-h2:text-3xl prose-h2:mt-10 prose-h2:mb-6 prose-p:text-slate-600 prose-p:leading-relaxed prose-li:text-slate-600 prose-li:marker:text-purple-500 prose-a:text-purple-600 prose-a:no-underline hover:prose-a:text-purple-700 prose-a:font-medium">
            <div className="bg-purple-50/70 rounded-xl p-6 mb-10 border-l-4 border-purple-500">
              <p className="text-lg font-medium text-purple-800">
                Esta web utiliza cookies y tecnologías similares para mejorar tu experiencia, analizar el tráfico y, en su
                caso, personalizar contenido. Al continuar navegando, aceptas su uso según esta política.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-10">
              <div>
                ...
                <p>
                  Son pequeños archivos que se alojan en tu dispositivo cuando visitas un sitio web. Pueden ser propias
                  o de terceros y permiten reconocer tu navegador o recordar ciertas preferencias.
                </p>
              </div>
              ...
              <div>
                ...
                <ul>
                  <li className="mb-2 flex items-start">
                    ...
                    <span><strong className="text-slate-800">Esenciales:</strong> necesarias para el funcionamiento básico del sitio (por ejemplo, navegación, seguridad).</span>
                  </li>
                  <li className="mb-2 flex items-start">
                    ...
                    <span><strong className="text-slate-800">Analíticas:</strong> nos ayudan a entender el uso del sitio para mejorarlo.</span>
                  </li>
                  <li className="flex items-start">
                    ...
                    <span><strong className="text-slate-800">Preferencias:</strong> recuerdan tus elecciones (por ejemplo, idioma).</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-10 mt-12">
              <div>
                ...
                <p>
                  Puedes configurar tu navegador para aceptar, bloquear o eliminar cookies. Ten en cuenta que bloquear
                  ciertas cookies podría afectar la funcionalidad del sitio. Consulta la ayuda de tu navegador para más
                  información.
                </p>
                ...
                <div className="mt-6 bg-slate-50 rounded-xl p-4 border border-slate-100">
                  ...
                  <p className="text-sm text-slate-600">
                    Para una experiencia óptima, te recomendamos aceptar cookies esenciales y de preferencias. 
                    Las cookies analíticas puedes desactivarlas si lo prefieres.
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <p>
                  Algunas herramientas de terceros (por ejemplo, mapas o reproductores incrustados) pueden establecer
                  sus propias cookies. No controlamos directamente estas cookies; recomendamos revisar sus políticas.
                </p>
                
                <div className="mt-4 flex flex-wrap gap-2">
                  <span className="px-3 py-1 bg-slate-100 rounded-full text-xs font-medium text-slate-700">Google Analytics</span>
                  <span className="px-3 py-1 bg-slate-100 rounded-full text-xs font-medium text-slate-700">YouTube</span>
                  <span className="px-3 py-1 bg-slate-100 rounded-full text-xs font-medium text-slate-700">Mapas</span>
                  <span className="px-3 py-1 bg-slate-100 rounded-full text-xs font-medium text-slate-700">Redes sociales</span>
                </div>
              </div>
            </div>
            ...
            <div className="mt-12">
              ...
              <p>
                Podemos modificar esta política para reflejar cambios en las cookies utilizadas o requisitos legales.
                Publicaremos la versión vigente en esta página.
              </p>
              ...
              <div className="mt-6 bg-blue-50 rounded-xl p-5 border border-blue-100">
                ...
                <p className="text-blue-700 text-sm">
                  Para cambios importantes en nuestra política de cookies, te notificaremos mediante un banner destacado 
                  en nuestro sitio web durante al menos 7 días antes de que los cambios entren en vigor.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-16 grid md:grid-cols-2 gap-6">
            <div className="p-6 bg-gradient-to-br from-purple-50 to-indigo-50 rounded-xl border border-purple-100/60 shadow-sm transition-all duration-300 hover:shadow-md hover:border-purple-300">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="font-semibold text-slate-800 text-lg">Gestión de Cookies</h3>
              </div>
              <p className="text-slate-600 text-sm mb-4">
                Puedes configurar tu navegador para controlar el uso de cookies según tus preferencias.
              </p>
              <div className="mt-4">
            ...
            <div className="p-6 bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl border border-blue-100/60 shadow-sm transition-all duration-300 hover:shadow-md hover:border-blue-300">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="font-semibold text-slate-800 text-lg">¿Necesitas ayuda?</h3>
              </div>
              <p className="text-slate-600 text-sm mb-4">
                Si tienes preguntas sobre cookies o necesitas asistencia técnica, contáctanos.
              </p>
              <Link 
                to="/" 
        ...
        <div className="mt-16 text-center">
          ...
          <p className="mt-8 text-sm text-slate-500 max-w-md mx-auto">
            Al continuar navegando en nuestro sitio, aceptas nuestro uso de cookies según lo descrito en esta política.
          </p>
        </div>
      </section>
