    ...
    <>
      ...
      <PageTransition>
        <div className="flex flex-col min-h-screen">
          <main className="flex-grow bg-gradient-to-b from-slate-50 via-white to-orange-50/10 relative">
        ...
        <div className="relative bg-gradient-to-r from-orange-600 via-orange-700 to-red-700 text-white pt-28 md:pt-32">
          ...
          <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 md:pb-20">
            <div className="text-center">
              ...
              <p className="text-lg md:text-xl text-orange-100 max-w-2xl mx-auto mb-6 leading-relaxed">
